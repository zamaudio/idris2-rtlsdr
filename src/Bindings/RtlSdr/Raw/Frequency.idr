module Bindings.RtlSdr.Raw.Frequency
...
set_xtal_freq: Ptr RtlSdrHandle -> Int -> Int -> PrimIO Int
...
get_xtal_freq: Ptr RtlSdrHandle -> Ptr Int -> Ptr Int -> PrimIO Int
...
set_freq_correction: Ptr RtlSdrHandle -> Int -> PrimIO Int

-- RTLSDR_API int rtlsdr_get_freq_correction(rtlsdr_dev_t *dev);
export
%foreign (librtlsdr "get_freq_correction")
get_freq_correction: Ptr RtlSdrHandle -> PrimIO Int
